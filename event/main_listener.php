 ...
 *
 * @copyright (c) 2019, CHAGNAUD DAMIEN
 * @license GNU General Public License, version 2 (GPL-2.0)
 *
 */

namespace forumphoto\addressbook\event;
...
class main_listener implements EventSubscriberInterface
{
	...
	public function load_language_on_setup($event)
	{
		...
		$lang_set_ext[] = array(
			'ext_name' => 'forumphoto/addressbook',
			'lang_set' => 'common',
		);
	...
	public function add_page_header_link()
	{
		$this->template->assign_vars(array(
			'U_DEMO_PAGE'	=> $this->helper->route('forumphoto_addressbook_controller', array('name' => 'world')),
		));
	}
	...
	public function viewonline_page($event)
	{
		if ($event['on_page'][1] === 'app' && strrpos($event['row']['session_page'], 'app.' . $this->php_ext . '/demo') === 0)
		{
			...
			$event['location_url'] = $this->helper->route('forumphoto_addressbook_controller', array('name' => 'world'));
		}
	}
}
